...
try:
    ...
    pytest.skip(
        "langgraph checkpoint dependencies not installed — skipping graph checkpointing tests",
...
try:
    ...
    pytest.skip(
        "solstein graph/review_queue modules not available — skipping graph checkpointing tests",
        allow_module_level=True,
    )
