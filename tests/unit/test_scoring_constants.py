...
class TestScoringConstants:
    ...
    def test_composite_weights_sum_to_one(self):
        ...
        total = (
            settings.composite.growth_weight
            + settings.composite.financial_weight
            + settings.composite.competitive_weight
        )
    ...
    def test_no_unexplained_numeric_literals_in_scoring(self):
        ...
        known_constants = {
            ...
            "0.90",
            "0.70",
            # confidence thresholds (from constants)
            "4.49",
            "4.5",
            "7.0",  # classification thresholds (from constants)
            "8.5",
            "2.0",
            "4.4",  # valuation constants (from constants)
        }
