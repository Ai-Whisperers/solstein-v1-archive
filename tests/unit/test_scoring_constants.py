...
class TestScoringConstants:
    ...
    def test_no_unexplained_numeric_literals_in_scoring(self):
        ...
        exclude_patterns = [
            ...
            r'""".*?"""',  # docstrings
            r"'''.*?'''",  # docstrings
            r'default_factory=',  # default factory calls
            r'getenv\(',
            r'os\.getenv',
            r'lambda:',
            r'\.\d{2,}[\d\-\+\*]',  # floating point operations
        ]
        
        with open('/tmp/solstein/src/solstein/analytics/scoring.py', 'r') as f:
            content = f.read()
        ...
        known_constants = {
            '0.40', '0.30', '0.30',  # weights (from config)
            '0.90', '0.70', '0.30',  # confidence thresholds (from constants)
    ...
    def test_classification_constants_named_and_documented(self):
        ...
        from solstein.analytics.constants import (
            PHOENIX_SCORE_THRESHOLD, SALT_SCORE_THRESHOLD, LEAD_SCORE_THRESHOLD
        )
...
class TestScoringMethodologyDocumentation:
    ...
    def test_constants_have_documentation(self):
        ...
        with open('/tmp/solstein/src/solstein/analytics/constants.py', 'r') as f:
            content = f.read()
