...
def sample_profiles():
    return [
        Company(
            id="1", name="Alpha", industry="Tech", 
            financials=FinancialMetric(revenue=1500000.0, growth_rate=25.0, employees=50, profit_margin=10.0, funding_raised=50000.0, valuation=10000000.0), 
            tier=CompanyTier.TIER_1, threat_level=ThreatLevel.HIGH, ai_maturity=AIMaturity.STRONG, saas_maturity=9, 
            geographic_presence=["US", "UK", "DE", "FR"],
            key_customers=["C1", "C2", "C3"],
            growth_score=8.5
        ),
        Company(
            id="2", name="Beta", industry="Energy", 
            financials=FinancialMetric(revenue=500000.0, growth_rate=-5.0, employees=None, profit_margin=None, funding_raised=None, valuation=None), 
            tier=CompanyTier.TIER_3, threat_level=ThreatLevel.LOW, ai_maturity=AIMaturity.LOW, saas_maturity=3,
            geographic_presence=[],
            key_customers=[],
            growth_score=None
        ),
        Company(
            id="3", name="Gamma Critical", industry="AI",
            financials=FinancialMetric(revenue=None, growth_rate=None, employees=None, profit_margin=None, funding_raised=None, valuation=None),
            tier=CompanyTier.TIER_4, threat_level=ThreatLevel.CRITICAL, ai_maturity=AIMaturity.MODERATE, saas_maturity=6,
