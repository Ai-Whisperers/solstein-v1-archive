...
def _enrich_with_mock(adapter: YahooFinanceEnrichment, **kwargs: Any) -> RawDataSource:
    ...
    with patch("solstein.data.company_research.CompanyResearcher") as mock_cls:
...
class TestYahooFinanceSuccessContract:
    ...
    def test_success_output_shape(self, adapter: YahooFinanceEnrichment, contract: dict[str, Any]) -> None:
