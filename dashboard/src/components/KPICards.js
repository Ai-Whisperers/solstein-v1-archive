...
export function KPICards({ companies }) {
    ...
    return (
        ...
        >
            ...
            <Card decoration="top" decorationColor="emerald" className="glass-card !bg-transparent !ring-solstein-border">
                <Text className="!text-solstein-text-muted uppercase tracking-widest text-xs">Rockets</Text>
                <Metric className="!text-solstein-gold">{rockets.length}</Metric>
