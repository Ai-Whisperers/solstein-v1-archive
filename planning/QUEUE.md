...
| 87 | STORY-178 | Map `funding_raised` to `total_funding_raised_eur` in Company | IN_PROGRESS | top-level Company.total_funding_raised_eur not populated; funding_data["total_funding_eur"] exists |
