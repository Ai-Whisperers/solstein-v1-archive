...
class EnrichmentCache:
    ...
    def get(self, company_name: str, params: Dict[str, Any]) -> Optional[List[Dict[str, Any]]]:
        ...
        try:
            ...
            for source in sources:
                source_dict = {
                    ...
                    "raw_content": source.raw_content if isinstance(source.raw_content, dict) else str(source.raw_content),
                }
