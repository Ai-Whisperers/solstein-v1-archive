...
# ============================================================================
# PHASE 12: ENRICHMENT ASYNC TASKS
# ============================================================================
...
def enrich_company_async(self, company_id: str, company_name: str | None = None, sources: list[str] | None = None, user_id: str | None = None):
...
def enrich_companies_batch_async(self, companies: list[dict], sources: list[str] | None = None, batch_size: int = 10, user_id: str | None = None):
