...
class DataConnector(Protocol):
    ...
    async def fetch_facts(
        self, company_ids: list[str], start_date: datetime | None = None, end_date: datetime | None = None
    ) -> list[dict[str, Any]]:
...
class CompanyRepository(Protocol):
    ...
    async def get_all(self, filters: dict[str, Any] | None = None) -> list[Any]:
...
class FactRepository(Protocol):
    ...
    async def get_by_company(self, company_id: str, fact_type: str | None = None) -> list[dict[str, Any]]:
...
class DataLoader(Protocol):
    ...
    async def load_companies(self, limit: int | None = None) -> list[Any]:
    ...
    async def load_company(self, company_id: str) -> Any | None:
...
class EnrichmentService(Protocol):
    ...
    async def enrich_company(self, company: Any, sources: list[str] | None = None) -> Any:
    ...
    async def enrich_batch(self, companies: list[Any], sources: list[str] | None = None) -> list[Any]:
