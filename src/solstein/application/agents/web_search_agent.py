...
from solstein.application.agents.base_agent import AgentTaskResult, BaseDataGatheringAgent
from solstein.application.agents.resilience import WEB_SEARCH_RETRY_CONFIG, CircuitBreaker, call_with_retry
...
class WebSearchAgent(BaseDataGatheringAgent):
    ...
    def _api_search_news(self, query: str) -> list[dict]:
        ...
        try:
            ...
            resp = httpx.get(self.search_base, params=params, timeout=15)
