...
def get_all_company_data(
    ...
    Returns:
        ...
        - Patent data
    """
    from solstein.infrastructure.data_loaders.company_research import research_company
    from solstein.infrastructure.data_loaders.fetchers import GlobalMarketLoader
