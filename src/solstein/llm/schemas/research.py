...
class CompanyExtractionResponse(BaseModel):
    ...
    def check_minimum_payload(self) -> CompanyExtractionResponse:
        ...
        no useful data.
        """
        populated = sum(1 for field_name in _MEANINGFUL_FIELDS if getattr(self, field_name, None) is not None)
    ...
    def is_minimal(self) -> bool:
        ...
        return not any(getattr(self, f, None) is not None for f in _SUBSTANCE_FIELDS)
